...
export default function PopupPage() {
  ...
  return (
    <div className="flex items-center justify-center min-h-screen bg-black">
      <div className="w-[375px] h-[600px] bg-[#0F0F0F] text-zinc-100 font-sans overflow-hidden relative shadow-2xl border border-zinc-800">
              ...
              <motion.div initial={{ x: "100%" }} animate={{ x: 0 }} exit={{ x: "100%" }} transition={{ type: "spring", damping: 25 }} className="absolute inset-0 bg-[#0F0F0F] z-50 flex flex-col">
                ...
                <div className="flex-1 px-4 space-y-6 pt-6 overflow-y-auto">
                 ...
                 <div className="p-4 pb-8 border-t border-white/5">
                   <button disabled={!privateKey} onClick={() => setScreen("s3")} className="w-full h-12 rounded-2xl bg-[#AB9FF2] text-black font-semibold text-[16px] disabled:opacity-50">Import</button>
                 </div>
              </motion.div>
            )}
